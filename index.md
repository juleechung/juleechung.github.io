...
<section class="hero project-hero">
  <div class="hero-inner">
    <div class="hero-logo-strip">
      <img src="images/nsf-logo.png" alt="National Science Foundation logo" class="nsf-logo">
      <img src="images/cra-wp-logo.png" alt="CRA-WP logo" class="cra-logo">
    </div>

    <p class="eyebrow">NSF DREAM RESEARCH APPRENTICESHIP 2026</p>
    <h1>Multimodal Human-Robot Interaction for Socially Grounded Environments</h1>
    <div class="hero-people">
      <div class="person-card">
        <img src="images/juleedp.png" alt="Julee Chung">
        <span>Julee Chung</span>
      </div>
      <div class="person-card">
        <img src="images/zhi-tan.jpg" alt="Prof. Zhi Tan">
        <span>Prof. Zhi Tan</span>
      </div>
      <div class="person-card">
        <img src="images/stacy-marsella.jpg" alt="Prof. Stacy Marsella">
        <span>Prof. Stacy Marsella</span>
      </div>
    </div>
    <p class="hero-affiliation">Khoury College of Computer Science, <strong>Northeastern University</strong>, Boston MA</p>
  </div>
</section>
...
<section class="content-section" id="project">
  ...
  <p>Robots have the potential to support people in shared physical environments, but they often struggle to understand the flexible, situated ways humans communicate. Simple references like "this," "that," or "over there" can depend on speech, gesture, spatial context, and shared attention.</p>

  <p>This research investigates multimodal human-robot interaction using Boston Dynamics' Spot robot, examining how robots can combine speech, gesture, and environmental context to interpret human intent and respond more naturally in socially grounded environments.</p>
...
<section class="content-section" id="advisor">
  ...
  <p>Professor Marsella's research focuses on computational models of cognition, emotion, and social behavior, with applications in virtual humans, social agents, and human-centered systems.</p>
</section>
